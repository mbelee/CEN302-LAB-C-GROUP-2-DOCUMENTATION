...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
        ...
        <a class="navbar-brand js-scroll-trigger" href="#"
           style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i
                        class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp HOSPITAL MANAGEMENT SYSTEM</h4></a>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item" style="margin-right: 40px;">
                    <a class="nav-link js-scroll-trigger" href="index.php"
                       style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>HOME</h6></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
            <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#receptionist" role="tab"
                       aria-controls="receptionist" aria-selected="false">Receptionist</a>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                    ...
                    <form method="post" action="patientRegister.php">
                        <div class="row register-form">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="date" class="form-control" placeholder="BirthYear *" name="birthyear"required/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="patient-login.php">Already have an account? Login Now</a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="tel" minlength="10" maxlength="10" name="telephone" class="form-control"placeholder="Telephone *"/>
                                </div>
                                <div class="form-group">
                ...
                <div class="tab-pane fade show" id="receptionist" role="tabpanel" aria-labelledby="profile-tab">
